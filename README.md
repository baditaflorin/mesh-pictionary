...
Live: **https://baditaflorin.github.io/mesh-pictionary/**

Source: **https://github.com/baditaflorin/mesh-pictionary**
...
git clone https://github.com/baditaflorin/mesh-pictionary
cd mesh-pictionary
npm install
npm run dev
```
...
- `mesh-pictionary:signalingUrl`
- `mesh-pictionary:turnTokenUrl`
- `mesh-pictionary:iceServers`
- `mesh-pictionary:room`
